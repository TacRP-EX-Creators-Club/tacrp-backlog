...
SWEP.Description = "A bizarre prototype AK with cues taken from the P90, found in the metro tunnels of Moscow.\nIt's operation is a bit of a mystery because it lacks a charging handle."
...
local path1 = "tacint_shark/metroak/metro_"
