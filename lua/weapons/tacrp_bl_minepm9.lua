...
SWEP.SightAng = Angle(-3.91, 0.55, 4.4)
SWEP.SightPos = Vector(-5.305, -5, -3)

SWEP.CorrectivePos = Vector(1.45, -4.4, 0.1)
SWEP.CorrectiveAng = Angle(2.3, -5, 0)
...
local path = "tacint_shark/minepm9/pm9_"
