...
// names and stuff
SWEP.PrintName = "Beretta Px4 Storm"
SWEP.AbbrevName = "Px4"
...
SWEP.Credits = [[Model: Duztey
Texture: The Spork, WangChung
Sounds: HK, Vunsunta, Greg_Boyington
Animations: Tactical Intervention]]

SWEP.ViewModel = "models/weapons/tacint_shark/v_px4.mdl"
SWEP.WorldModel = "models/weapons/tacint_shark/w_px4.mdl"
...
SWEP.SightPos = Vector(-3.465, 0, -3.12)
...
SWEP.ClipSize = 14
SWEP.Ammo = "pistol"
SWEP.Ammo_Extended = "ti_pistol_heavy"
...
local path2 = "tacint_shark/px4/"

SWEP.Sound_Shoot = "^" .. path2 .. "fiveseven-1.wav"
...
addsound("tacint_px4.clip_in", path2 .. "clipin.wav")
addsound("tacint_px4.clip_in-mid", path2 .. "clipin.wav")
addsound("tacint_px4.clip_out", path2 .. "clipout.wav")
addsound("tacint_px4.slide_action", path2 .. "slideaction.wav")
addsound("tacint_px4.slide_shut", path2 .. "forward.wav")
addsound("tacint_px4.cock_hammer", path .. "cockhammer.wav")
